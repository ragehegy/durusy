...
class RegistrationForm(Form):
    first_name = StringField('First Name', validators=[Required(), Length(1, 64), Required()])
    last_name = StringField('Last Name', validators=[Required(), Length(1, 64), Required()])
    email = StringField('Email', validators=[Required(), Length(1, 64), Email()])
    ...
    govern = StringField('Govern', validators=[Required(), Length(1, 64), Required()])
